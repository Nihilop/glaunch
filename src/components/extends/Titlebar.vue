<template>
  <div data-tauri-drag-region class="select-none flex fixed top-0 left-0 right-0 justify-end h-12 items-center transition-all duration-500 space-x-4 px-5 z-40 group">
